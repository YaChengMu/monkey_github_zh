...
I18N.zh = {
  ...
  "vis-public": { // 仓库页
    "static": { // 静态翻译
      ...
      "There is no need to keep this window open, we’ll email you when the import is done.": "没有必要打开这个窗口，导入完成后我们会发邮件给你。",
      ...
      // 仓库页面
      "Where should we fork this repository?": "我们应该把这个存储库放在哪里？",
      "Code": "代码",
      "Pulse": "统计",
      "Graphs": "图表",
      "Projects": "项目",
